...
class SessionManager:
    ...
    def is_authenticated(self) -> bool:
        """Check if the current Streamlit session has a valid authentication token."""
        return st.session_state.get('authentication_status', False) is True
    
    def destroy_session(self) -> None:
        """End the current session (convenience for app.py logout button)."""
    ...
    def create_session(self, user_id: int, user_agent: Optional[str] = None, ip_address: Optional[str] = None) -> Optional[str]:
