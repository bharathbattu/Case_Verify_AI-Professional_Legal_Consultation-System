...
try:
    # Try to import full authentication system first
    from .authenticator import get_authenticator, register_user, get_user_info
    ...
    if not _auth_status_logged:
        logger.info("Using simplified authentication system")
        _auth_status_logged = True
    
    try:
        # Fallback to simplified authentication
        from .simple_auth import get_authenticator, register_user, get_user_info
        
        class UserManager:
            """Simplified UserManager"""
            def __init__(self):
                pass
